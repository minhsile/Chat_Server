...
ref class DownloadPublicFileStruct :public ChatStruct
{
public:
	...
	virtual array<Byte>^ pack() override {
		...
		byteData->AddRange(BitConverter::GetBytes(int(ChatStruct::MessageType::DownloadPublicFile)));
