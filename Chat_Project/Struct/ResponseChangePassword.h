...
ref class ResponseChangePasswordStruct : public ChatStruct
{
public:
	bool IsSucc;
	String^ errorMsg;
	ResponseChangePasswordStruct() //Default constructor
	{
	...
	virtual array<Byte>^ pack() override
	{
		...
		byteData->AddRange(BitConverter::GetBytes(int(ChatStruct::MessageType::ResponseChangePassword)));
